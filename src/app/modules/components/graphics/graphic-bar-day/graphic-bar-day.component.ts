...
@Component({
  selector: 'app-graphic-bar-day',
  templateUrl: './graphic-bar-day.component.html',
})
export class GraphicBarDayComponent implements OnInit {
  ...
  generateBarChart(): void {
    ...
    this.graphicBarService.generateBarChartDay(canvas, this.title, this.label1, this.label2, this.color1, this.color2, this.infoOfGraphicBar, this.filter1, this.filter2, new Date());
  }
