...
@Component({
  selector: 'app-graphic-bar2-day',
  templateUrl: './graphic-bar2-day.component.html',
})
export class GraphicBar2DayComponent implements OnInit {
  ...
  handleMailsUpdate(alertMails: MailInfoModel[], reportMails: MailReportModel[]): void {
    ...
    this.chartService.generateBarChartDay(canvas, 'Cantidad de alertas enviadas y reportes realizados hoy', alertMails, reportMails);
  }
