...
@Component({
  selector: 'app-graphic-bar2',
  templateUrl: './graphic-bar2.component.html',
  styleUrls: []
})
export class GraphicBarComponent2 implements OnInit {
  ...
  handleMailsUpdate(alertMails: MailInfoModel[], reportMails: MailReportModel[]): void {
    ...
    this.chartService.generateBarChart(canvas, 'Cantidad de alertas enviadas y reportes realizados en los últimos 7 días', alertMails, reportMails);
  }
}
