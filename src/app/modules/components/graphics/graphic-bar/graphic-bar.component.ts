...
export class GraphicBarComponent implements OnInit, AfterViewInit {
  ...
  generateBarChart(): void {
    ...
    this.graphicBarService.generateBarChart(canvas, this.title, this.label1, this.label2, this.color1, this.color2, this.infoOfGraphicBar, this.filter1, this.filter2);    
  }
}
